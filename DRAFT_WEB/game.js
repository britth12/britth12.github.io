...
const OVERLAY_MENU  = 0.96;
const OVERLAY_GAME  = 0.52;

const START_TITLE_H  = 110;
const START_SUB_H    = 88;
const START_PROMPT_H = 32;

const HUD_LABEL_H  = 28;
const HUD_NUM_H    = 38;
const HUD_TIME_GAP = 20;

const END_GAMEOVER_H = 90;
const END_TRAVELER_H = 30;
const END_SCORE_H    = 200;
...
function drawStartScreen() {
  ...
  drawStr(W/2,ty,'AUDIOMANCER',START_TITLE_H,'center');
...
function drawGame(t) {
  ...
  drawBG(OVERLAY_GAME); drawLedges(); drawNumbers(now); drawWizard(); drawHUD();
}
